...
public class OWLtoRF2Service {
    ...
    public void writeToRF2(InputStream owlFileStream, OutputStream rf2ZipOutputStream, Date fileDate) throws OWLException, IOException {
        ...
        UnmodifiableIterator var6 = Sets.union(owlOntology.getObjectPropertiesInSignature(), owlOntology.getClassesInSignature()).iterator();

        while(var6.hasNext()) {
            OWLEntity owlEntity = (OWLEntity)var6.next();
